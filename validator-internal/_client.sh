...
case $state in
  ops)
    ...
    _values "Operations" \
            "isLive[]" \
            "isReady[]"             "cancelTransferPreapprovalByParty[]" \
            ...
            "submitTransferPreapprovalSend[]"             "getValidatorUserInfo[]" \
  ...
  args)
    case $line[1] in
      ...
      getValidatorDomainDataSnapshot)
        local -a _op_arguments
        _op_arguments=(
                    "timestamp=:[QUERY] The timestamp as of which the dump (in particular, the ACS) is valid.

Must in the ISO-8601 format in UTC timezone, e.g.,
&#39;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSS&#39;Z&#39;&#39;."
"migration_id=:[QUERY] The current migration id."
"force=true:[QUERY] If true, do not check whether the provided timestamp is clean.
Not recommended for production,
see the &#39;ExportAcs&#39; endpoint of the &#39;ParticipantRepairService&#39; participant gRPC API."
          "force=false:[QUERY] If true, do not check whether the provided timestamp is clean.
Not recommended for production,
see the &#39;ExportAcs&#39; endpoint of the &#39;ParticipantRepairService&#39; participant gRPC API."
          )
        _describe -t actions 'operations' _op_arguments -S '' && ret=0
